        ...
        <div className="px-4 py-5 sm:p-6">
          <div className="sm:flex sm:items-start sm:justify-between">
            <div>
              ...
              Describe the contents of the image using AI
              </p>
            </div>
        ...
        <div className="flex flex-col justify-center items-center w-full h-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
          {loading ? (
            ...
            <div className="text-gray-300 whitespace-pre-wrap text-left w-full">
              <h3 className="text-lg font-bold mb-4">Generated Caption:</h3>
              {outputText}
            </div>
          ) : (
            <span className="text-gray-500">AI-generated caption will appear here.</span>
          )}
        </div>
      </section>
...
<section className="mt-12 px-4 lg:px-6 xl:px-8">
  ...
  <p className="text-gray-400 mb-4">
    To generate a caption for your image:
  </p>
  <ul className="list-disc list-inside text-gray-400 mb-6">
    <li>Upload an image using the upload section above.</li>
    <li>Wait for the AI to process the image and generate a descriptive caption.</li>
    <li>View the generated caption displayed in the output section.</li>
  </ul>
  <h3 className="text-lg font-semibold text-gray-300 mb-2">Example:</h3>
  <p className="text-gray-400 mb-4">
    Below is an example of an image and the caption generated by the AI.
  </p>
  <div className="rounded-lg border-2 border-dashed border-gray-300 p-6">
    <img
      src="/6ex.jpg"
      alt="Example of image caption generation"
